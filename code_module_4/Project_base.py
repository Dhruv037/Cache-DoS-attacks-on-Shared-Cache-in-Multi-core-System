...
parser.add_option('--l1i_size', default=None, help="L1 instruction cache size")
parser.add_option('--l1d_size', default=None, help="L1 data cache size")
parser.add_option('--l2_size', default=None, help="Unified L2 cache size")
parser.add_option("-c", "--cmd", default="", help="The binary to run in syscall emulation mode.")
parser.add_option("-o", "--options", default="", help="""The options to pass to the binary, use " " around the entire strin""")
...
cpus = 4
cpu = [DerivO3CPU(cpu_id = i) for i in range(cpus)]
system.cpu = cpu
